...
final class C0007 implements Comparator<HashMap<String, Object>> {

    /* renamed from: ۬ */
    final /* synthetic */ AsyncTaskC0006 f147;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C0007(AsyncTaskC0006 asyncTaskC0006) {
        this.f147 = asyncTaskC0006;
    }
    ...
    public final /* synthetic */ int compare(HashMap<String, Object> hashMap, HashMap<String, Object> hashMap2) {
        ...
        Iterator<String> it = this.f147.f133.f7.iterator();
        boolean z2 = false;
        boolean z3 = false;
        while (true) {
            if (!it.hasNext()) {
