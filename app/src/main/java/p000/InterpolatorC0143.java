...
final class InterpolatorC0143 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        int min = Math.min((int) ((f359.length - 1) * f), f359.length - 2);
        return ((f359[min + 1] - f359[min]) * ((f - (min * f360)) / f360)) + f359[min];
    }
}
